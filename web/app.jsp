      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12 col-12">
          <div class="header-content">
            <h1>Healthcare Information Management System (MIS).</h1>
            <p>
            ...
            <div class="button">
              <a href="BookingAction" class="btn primary-btn">Book Appointment</a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="content">
              <h6>Summary</h6>
              <h2 class="fw-bold">Total Uses</h2>
              <p>
                There are many variations of passages of Lorem Ipsum available,
                but the majority have suffered alteration in some form.
              </p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6 col-12">
          <div class="pricing-style-fourteen">
            <div class="table-head">
              <h6 class="title">Happy Patients</h6>
                <p>EasyHealth successfully serve our happy patients.</p>
                <div class="price">
                  <h2 class="amount">
                    <span class="currency"></span>
                    <s:property value="totalPatients"/>
                    <span class="duration">Patients </span>
                  </h2>
                </div>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 col-12">
          <div class="pricing-style-fourteen">
            <div class="table-head">
              <h6 class="title">Medical Image Analysis</h6>
        ...
        <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-9">
          <div class="inner-content">
            ...
            <div class="light-rounded-buttons">
              <a href="BookingAction" class="btn primary-btn-outline">Book Appointment</a>
            </div>
          </div>
        </div>
      </div>
